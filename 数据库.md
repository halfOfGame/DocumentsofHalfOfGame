...
- 查询从 `2019-06-30` 起最多 90 天内，每天首次登录的用户数。
...
-  [MySQL的连接查询：left join , right join , join](https://blog.csdn.net/lp_cq242/article/details/79942457)